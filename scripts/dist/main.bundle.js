...
/***/ function(module, exports, __webpack_require__) {
	...
	var _paperjpeg = __webpack_require__(5);
	
	var _paperjpeg2 = _interopRequireDefault(_paperjpeg);
	...
	window.onload = function () {
	  ...
	  utils.getJson('config.json').then(function (config) {
	    initPaper(_paper2.default, config, data);
	  });
	}; /*jshint esversion: 6 */
	
	function initPaper(paper, config, data) {
	
	  var paperjpeg = new _paperjpeg2.default(paper);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var window = self ? self.window : __webpack_require__(2),
...
/***/ function(module, exports) {
	...
	exports.createJpeg = createJpeg;
	exports.getBannedDataFromUrl = getBannedDataFromUrl;
	exports.getAnchoredPosition = getAnchoredPosition;
	exports.getScaledSize = getScaledSize;
	exports.addImageRaster = addImageRaster;
	exports.addTextPoint = addTextPoint;
	...
	function createJpeg(canvas_elem, image_elem) {
	  return new Promise(function (resolve, reject) {
	    setTimeout(function () {
	...
	function getAnchoredPosition(context_size, item_size, xAnchor, yAnchor, x, y) {
	...
	function getScaledSize(item, scaleX, scaleY) {
	  return [item.size.width * scaleX, item.size.height * scaleY];
	}
	
	function addImageRaster(paper, src) {
	  return new Promise(function (resolve, reject) {
	...
	function addTextPoint(paper, content, size, style, position) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PaperJpeg = function () {
	  function PaperJpeg(paper) {
	    _classCallCheck(this, PaperJpeg);
	  ...
	  _createClass(PaperJpeg, [{
	    ...
	    key: 'addImage',
	    value: function addImage(src, scale, _ref) {
	      var _ref$xAnchor = _ref.xAnchor;
	      var xAnchor = _ref$xAnchor === undefined ? 'left' : _ref$xAnchor;
	      var _ref$yAnchor = _ref.yAnchor;
	      var yAnchor = _ref$yAnchor === undefined ? 'top' : _ref$yAnchor;
	      var _ref$x = _ref.x;
	    ...
	    value: function addImages(images) {
	      ...
	      return new Promise(function (resolve, reject) {
	        ...
	        images.forEach(function (image) {
	          self.addImage(image.src, image.scale, image.position).then(function (raster) {
	            rasters.push(raster);
	    ...
	    key: 'addForm',
	    value: function addForm(formText, textStyle) {
	      var self = this;
	      var form = new _form2.default(self.paper);
	    ...
	    key: 'addBannedText',
	    value: function addBannedText(config, data) {
	      var self = this;
	      config.texts.forEach(function (text) {
	        ...
	        utils.addTextPoint(self.paper, content, text.max_size, config.textStyle, text.position);
	      });
	      self.render();
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function () {
	  ...
	  _createClass(Form, [{
	    key: 'init',
	    value: function init(formText, textStyle) {
	      var self = this;
	      return new Promise(function (resolve, reject) {
	        ...
	        utils.addTextPoint(self.paper, formText, '40px', textStyle, {
	          'xAnchor': 'center',
	          'yAnchor': 'center',
	          'x': 0,
	          'y': -30
	    ...
	    value: function openResultWindow() {
	    ...
	    value: function handleFieldChange(e, field) {
	      var self = this;
	      if (e) {
	    ...
	    key: 'showEnterButton',
	    value: function showEnterButton() {
	      if (this.enter) this.enter.visible = true;
	    }
	  }, {
	    key: 'hideEnterButton',
	    value: function hideEnterButton() {
	      if (this.enter) this.enter.visible = false;
	    }
	  }, {
	    key: 'addField',
	    value: function addField(name, yOffset) {
	      var field = new _formfield2.default(this.paper, name);
	      this.fields.push(field);
	      return field.init(new this.paper.Size(200, 40), { y: yOffset });
	    }
	  }, {
	    key: 'generateQueryString',
	    value: function generateQueryString() {
	    ...
	    key: 'allFieldsAreFilled',
	    value: function allFieldsAreFilled() {
	      var allFilled = true;
	      this.fields.forEach(function (field) {
	    ...
	    value: function getSelectedField() {
	    ...
	    key: 'toggleFieldSelection',
	    value: function toggleFieldSelection() {
	      this.fields.forEach(function (field) {
	        if (field.selected) {
	          field.unselect();
	        } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var FormField = function () {
	  ...
	  _createClass(FormField, [{
	    key: 'init',
	    value: function init(size, _ref) {
	      var _ref$xAnchor = _ref.xAnchor;
	      var xAnchor = _ref$xAnchor === undefined ? 'center' : _ref$xAnchor;
	      var _ref$yAnchor = _ref.yAnchor;
	      var yAnchor = _ref$yAnchor === undefined ? 'center' : _ref$yAnchor;
	      var _ref$x = _ref.x;
	      var x = _ref$x === undefined ? 0 : _ref$x;
	      var _ref$y = _ref.y;
	      var y = _ref$y === undefined ? 0 : _ref$y;
